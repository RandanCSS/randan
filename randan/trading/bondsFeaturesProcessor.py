...
# 1.6 Расчёт доходности в день до возможности погасить 
    ...
    bondS['Бескупонная доходность'] = 1000 * (100 - bondS['PRICE']) / 100
    bondS['Бескупонная доходность'] = bondS['Бескупонная доходность'].astype(float).round(2)
    
    # Годовая доходность к погашению = суммарный доход к полной цене покупки
    bondS['% доходности годовых к погашению'] =\
        365 * (
        100 * (1000 + bondS['Купоный доход к погашению'] + bondS['Бескупонная доходность'])\
