...
--- хотите, чтобы я выяснял неостающий на сайте moex.ru ? Тогда нажмите ПРОБЕЛ и затем Enter (так медленнее, но потенциально точнее, хотя обычно рейтинги эмитента и его несубординированной облигации одинаковы)
'''
              )
        userChoice = input()
    ...
    for textTarget in textTargetDict.keys():
        ...
        bondS_withoutRating = bondS[(bondS[column_target].isna()) | (bondS[column_target] == '')]
