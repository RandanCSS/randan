...
# 1.1 для обработки выдачи любого из методов
...
# 1.3 для парсинга пользовательского временнОго диапазона в случае использования сохранённого следа и в случае назначения пользовательского временнОго диапазона
...
# 2.1.1 Этап сегментирования по годам (stage = 1)
    stage = 1
    if stage >= stageTarget: # eсли нет временного файла stage.txt с указанием пропустить этап
