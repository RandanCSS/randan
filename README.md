...
We recommend using the second way and clone our package every time you're going to use it as it allows you to have all the updates in time. If you had already cloned the package folder once, next time use this command to get updates: `!git pull https://github.com/LanaLob/randan.git`
